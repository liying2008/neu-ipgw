...
public class FaqListAdapter extends BaseAdapter {
    ...
    private List<RecentPost> faqList = new ArrayList<>();
    private Activity context;
    private LayoutInflater inflater;

    public FaqListAdapter(Activity context) {
        this.context = context;
        inflater = LayoutInflater.from(context);
    }

    public void setData(List<RecentPost> faqList) {
        if (faqList != null) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView != null) {
            ...
            convertView = inflater.inflate(R.layout.item_app_faq, parent, false);
        ...
        String dateMsg = "发布日期：" + post.getDate();
